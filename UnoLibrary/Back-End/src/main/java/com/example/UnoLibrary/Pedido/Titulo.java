...
import com.example.UnoLibrary.Model.entity.TituloAutor;
import com.example.UnoLibrary.Model.entity.TituloEditora;
...
public class Titulo implements Serializable {
    ...
    public List<Titulo> buscaTitulo(String nome){
        TituloRepository repo;
        return repo.tituloRepository.findByTitulo(nome);
    }
